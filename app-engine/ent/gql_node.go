...
func (i *Item) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(i.Slug); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
...
func (s *Shopping) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     s.ID,
		Type:   "Shopping",
		Fields: make([]*Field, 3),
	...
	if buf, err = json.Marshal(s.Date); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "time.Time",
...
func (si *ShoppingItem) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     si.ID,
		Type:   "ShoppingItem",
		Fields: make([]*Field, 7),
	...
	if buf, err = json.Marshal(si.UpdateTime); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "time.Time",
	...
	if buf, err = json.Marshal(si.Quantity); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "float64",
	...
	if buf, err = json.Marshal(si.QuantityType); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(si.Units); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(si.Brand); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(si.PricePerUnit); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
...
func (u *User) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(u.ExternalID); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(u.OtherNames); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(u.IsEmailVerified); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "bool",
	...
	if buf, err = json.Marshal(u.ExternalSource); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case item.Table:
		...
		return n, nil
	case shopping.Table:
		n, err := c.Shopping.Query().
			Where(shopping.ID(id)).
			CollectFields(ctx, "Shopping").
			Only(ctx)
		if err != nil {
			return nil, err
		}
		return n, nil
	case shoppingitem.Table:
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	case shopping.Table:
		nodes, err := c.Shopping.Query().
			Where(shopping.IDIn(ids...)).
			CollectFields(ctx, "Shopping").
			All(ctx)
		if err != nil {
			return nil, err
